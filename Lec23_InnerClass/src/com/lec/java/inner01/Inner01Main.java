...
public class Inner01Main {
	...
	public static void main(String[] args) {
		...
		// 새로운 외부 클래스 인스턴스 생성
		// out2 외부 클래스 인스턴스 생성
		// out2 로부터 in4, in5 라는 이름으로 내부 클래스 객체를 만드세요.
		TestOuter out2 = new TestOuter(200);
		TestOuter.TestInner in4 = out2.new TestInner(204);
		in4.printOuterValue();
		in4.printInnerValue();
		
		TestOuter.TestInner in5 = out2.new TestInner(205);
		in5.printOuterValue();
		in5.printInnerValue();
