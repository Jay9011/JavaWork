...
public class PrintFormatMain {
	...
	public static void main(String[] args) {
		...
		// printf("서식문자열", 값1, 값2, ...)
		// 서식문자열 안에는 % 로 시작하는 '서식지정자'들이 들어간다.
...
//		System.out.printf("합격률은 %.1f%입니다.", rate);	// %문자는 서식 지정자를 나타내므로 예외 발생
		...
		System.out.printf(fmt, "서울", 12345);
		System.out.printf(fmt, "광주", 44);
		System.out.printf(fmt, "대구", 776);
