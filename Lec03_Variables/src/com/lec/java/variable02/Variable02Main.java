...
public class Variable02Main {
	...
	public static void main(String[] args) {
		...
		byte num2 = 0;
		byte num3 = 123;
//		byte num4 = 1234;	// 에러 : byte 에 저장할 수 있는 크기를 넘음

		System.out.println("short : " + Short.MIN_VALUE + " ~ " + Short.MAX_VALUE);
		short num5 = -12345;
		short num6 = 12345;
//		short num7 = 32768;	// 에러 : short 에 저장할 수 있는 크기를 넘음
//		short num8 = -32769;
...
//		long num10 = 9876543210;	// The literal 9876543210 of type int is out of range
		// 리터럴 : literal
		// 	코드상에 직접 입력한 값들
		//		정수 리터럴 --> int 로 형변환 하려 한다.
		//		실수 리터럴 --> double 로 형변환 하려 한다.
		//		"~" 리터럴 --> String(문자열) 로 형변환
		//		Long형 리터럴 --> 정수의 끝에 L을 붙여서 Long 형으로 인식시킨다.
		
		long num11 = 9876543210L;
		long num12 = 12;
		long num13 = 12L;
		int num14 = 12;
//		int num15 = 21L;	// Long 타입은 int 에 대입 불가
		
		// 값의 경계선
		//	음수를 표현하는 부호비트가 제일 앞에 위치해 있기 때문에 자리올림이 발생하면 음수의 최대값이 나온다.
