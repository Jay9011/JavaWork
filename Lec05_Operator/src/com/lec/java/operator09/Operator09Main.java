...
//		byte b3 = b1 + b2;		// byte + byte -> int
		...
		short s1 = 10, s2 = 20;
//		short s4 = s1 + s2;		// short + short -> int
...
//		f3 = f1 + d1;			// float + double -> double
		...
		// int 이하 연산 결과 무조건 int 이기 때문에 주의!
		long l2= 27000000000L;
		System.out.println("l2 : " + l2);
		
		l2 = 3000 * 3000 * 3000;	// int 끼리 연산했기 때문에 연산 결과 int의 범위를 벗어날 수 없다.
		System.out.println("l2 : " + l2);
		
		// 자바의 연산결과 타입 규칙과
		// 기본데이터 타입의 함계값 인지하고 있어야 함.
