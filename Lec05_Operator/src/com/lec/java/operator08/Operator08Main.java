...
public class Operator08Main {
	...
	public static void main(String[] args) {
		...
		byte n2 = 7;			//   0000 0111
								// & ---------
		int result = n1 & n2;	//   0000 0010
		System.out.println("& 결과 : " + result);
		System.out.println("& 결과 : " + String.format("%08d", Integer.parseInt(Integer.toBinaryString(result))));
		...
		int n3 = 10;			// 0000 1010
								// 0000 0101
		int result2 = n3 >> 1;	// 비트를 오른쪽으로 1bit씩 이동
		System.out.println(">> 결과 : " + result2);
		System.out.println(">> 결과 : " + String.format("%08d", Integer.parseInt(Integer.toBinaryString(result2))));

		result2 = n3 << 1;	// 비트를 왼쪽으로 1bit씩 이동
		System.out.println("<< 결과 : " + result2);
		System.out.println("<< 결과 : " + String.format("%08d", Integer.parseInt(Integer.toBinaryString(result2))));
