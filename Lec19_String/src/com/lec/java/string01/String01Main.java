...
//		System.out.println(str2 + str1);
		...
		str1.concat(str2);
		System.out.println("변경 전 str1 : " + str1);	// <-- 변경 안됨
		str3 = str1;
		str1 = str1.concat(str2);	// 변경하려면 이와 같이 덮어쓰기
		System.out.println("변경 후 str1 : " + str1);	// <-- 변경 됨
		...
		str3 = "";							// empty 문자열, Strin객체는 존재하나 비어있는 문자열
		System.out.println(str3.length());
		str3 = null;
//		System.out.println(str3.length());	// null, String 객체가 존재하지 않음
...
//		System.out.println(str1.charAt(100));	// StringIndexOutOfBoundsException
		...
		String[] date2 = str4.split("-");
		String[] time2 = str4.split(":");
		System.out.println("date : " + date);
		System.out.println("time : " + time);
		System.out.println("year : " + date2[0]);
		...
		System.out.println(str8.substring(2, 5));	// 2부터 5이전 까지
