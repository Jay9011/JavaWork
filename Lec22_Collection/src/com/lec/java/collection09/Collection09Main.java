...
//		System.out.println(subSet);	// toString 이 기본적으로 Overriding 되어있다.

		subSet = (TreeSet<Integer>)tset.subSet(3, 10);	// 데이터가 없어도 범위 안에 있다면 뽑아낼 수 있다.
		System.out.println(subSet);

		subSet = (TreeSet<Integer>)tset.subSet(5, true, 14, true);	// 5와 14를 포함해서 저장!!
		System.out.println(subSet);
