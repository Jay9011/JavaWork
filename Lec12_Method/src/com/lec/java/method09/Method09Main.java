...
public class Method09Main {
	...
	public static void main(String[] args) {
		...
		int n = 10;
		incNum(n);
		System.out.println("incNum(int) 호출 후 n : " + n);
		System.out.println();
		
		int[] arr = {10};
		incNum(arr);
		System.out.println("incNum(int[]) 호출 후 arr[0] : " + arr[0]);
		System.out.println();
		
		String t = "main";
		incNum(t);
		System.out.println("incNum(String) 호출 후 t : " + t);
		System.out.println();
	...
	public static void incNum(String t) {
		t = "incNum 참조";
		System.out.println("incNum(String) : " + t);
	}
