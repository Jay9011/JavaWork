...
public class Crawl17Main {
	...
	private static final String WEB_DRIVER_PATH = "C:/Java/chromedriver.exe";
...
//		app.likeFaceBook();
	...
	public void init() {
		...
		options.setCapability("ignoreProtectedModeSettiongs", true);
...
//		element.submit();
	...
	public void likeFaceBook() {
		...
		driver.findElement(By.id("email")).sendKeys("none@none");
