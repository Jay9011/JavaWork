 ...
 * 샘플url
 * XML 버젼
 * http://openapi.seoul.go.kr:8088/46476a646a74726f38336a6b78774b/xml/CardSubwayStatsNew/1/5/20181001
 * 예) http://openapi.seoul.go.kr:8088/4d46796d7366726f3833774a774955/xml/CardSubwayStatsNew/1/5/20181001
 *   
 * JSON 버젼
 * http://openapi.seoul.go.kr:8088/46476a646a74726f38336a6b78774b/json/CardSubwayStatsNew/1/5/20181001
...
public class Crawl14Main {
	...
	public static void main(String[] args) throws IOException {
		System.out.println("jackson-databind 연습 : URL -> jason -> Java");
		
		ObjectMapper mapper = new ObjectMapper();
		
		URL url = new URL("http://openapi.seoul.go.kr:8088/46476a646a74726f38336a6b78774b/json/CardSubwayStatsNew/1/5/20181001");
		...
		for (SubRow e : subway.getCardSubwayStatsNew().getRow()) {
			...
			System.out.printf("%5s : %8s역 [승차:%6d 하차:%6d]\n", 
					e.getLienNum(), e.getStationName(), e.getRidePassenger(), e.getAlightPassenger());
...
class SubRow {
	...
	public SubRow(String lienNum, String stationName, int ridePassenger, int alightPassenger) {
		super();
		this.lienNum = lienNum;
		this.stationName = stationName;
		this.ridePassenger = ridePassenger;
		this.alightPassenger = alightPassenger;
	}

	public String getLienNum() {return lienNum;}

	public void setLienNum(String lienNum) {this.lienNum = lienNum;}
