...
//		}
	...
	public void download1(String srcUrl) throws IOException {
		...
		url = new URL(srcUrl);
		in = url.openStream();	// URL -> openStream()
		...
		System.out.println("다운로드 완료! " + srcUrl + " → " + dstFile);
	...
	public void download2(String srcUrl) throws IOException {
		...
		String contentType = conn.getContentType();		// 파일종류 MIME-TYPE 확인 가능
