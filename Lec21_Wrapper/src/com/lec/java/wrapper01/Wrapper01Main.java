...
public class Wrapper01Main {
	...
	public static void main(String[] args) {
		...
		Integer num3 = new Integer(123);	// new 는 새로운 Instance 를 생성한다.
		Integer num4 = Integer.valueOf(123);// valueOf() 는 생성한 Object 를 cache 해둔다.
											// 동일 literal 로 valueOf() 생성하면, 
											// 기존에 생성된 Object 리턴.
											// 왜? ... 메모리 절약
		
		if(num1 == num3) {		// new 로 생성한 것들끼리 비교
			System.out.println("생성자 : 같은 참조");
		} else {
			System.out.println("생성자 : 다른 참조");
		}

		if(num2 == num4) {		// valueOf() 로 생성한 것들끼리 비교
		...
		if(num6 == num5) {
			...
			System.out.println("다른 참조");	// Wrapper 는 immutable 하다!
		}
